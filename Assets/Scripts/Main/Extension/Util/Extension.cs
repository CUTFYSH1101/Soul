...
namespace Main.Util
{
    ...
    public static class Extension
    {
        ...
        /// 該項目是否為空
        // ReSharper disable once AssignNullToNotNullAttribute
        public static bool IsEmpty(this KeyCode source) => source == default;

        /// 該項目是否為空
        // ReSharper disable once AssignNullToNotNullAttribute
        public static bool NotEmpty<T>(this T source) => source != null && !source.Equals("");
    }
    ...
    {
        public static string ArrayToString(this IEnumerable<object> source) => $"[{string.Join(",", source.Select(s=>s.ToString()))}]";
        /// 將2維陣列轉為1維
