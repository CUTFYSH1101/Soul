...
{
    /*// 代理模式
    public class CreatureComponent : AbstractCreature
    {
        private readonly AbstractCreature subject;
        public AbstractCreature GetTarget() => subject.GetCreatureAI().GetAIState().GetTarget();
