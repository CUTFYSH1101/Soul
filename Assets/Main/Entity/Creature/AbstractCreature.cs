...
{
    [Serializable]
    public abstract class AbstractCreature : IEntity
    {
        ...
        public AbstractCreatureBehavior Behavior { get; protected set; }
            ...
            [CanBeNull] DictionaryAudioPlayer audioPlayer = null)
        {
            ...
            _groundChecker = (GroundChecker) AppendComponent(new GroundChecker(this)); // 地板更新事件
        ...
        private class GroundChecker : IComponent
        {
            ...
            public GroundChecker(AbstractCreature creature)
            {
