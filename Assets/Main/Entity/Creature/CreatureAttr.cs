...
namespace Main.Entity.Creature
{
    ...
    public class CreatureAttr
    {
        ...
        [SerializeField] private EnumSkillTag skillState;
        [SerializeField] private DeBuffList deBuffList = new DeBuffList();
        ...
        // * 命名規範：xxx
        // ======
        [SerializeField, Tooltip("角色名稱")] private string name = "";

        // [SerializeField] private bool alive = true;
        [SerializeField] private bool movableCoeff = true;
        ...
        [SerializeField, Description("攻速。數值越大，動畫播放越快，cd越短。為n倍原速")]
        ...
        private BoolItem _movableItem;

        private BoolItem _attackableItem;
        ...
        public bool Alive
        {
            get => MindState != EnumMindState.Dead;
            set => MindState = value ? default : EnumMindState.Dead;
        }
        ...
        public bool MovableDyn
        {
            ...
            set
            {
                _movableItem.SetValue(value);
                movableCoeff = _movableItem.GetValue();
            }
        }
        ...
        {
            get => Alive && _attackableItem.GetValue() && !CanNotControlled() && attackableCoeff;
            set
            {
                _attackableItem.SetValue(value);
                attackableCoeff = _attackableItem.GetValue();
            }
        }
        ...
        public void AppendDeBuff(DeBuff newDeBuff)
            => deBuffList.Append(newDeBuff);

        public void RemoveDeBuff(DeBuff deBuff)
            => deBuffList.Remove(deBuff);

        public DeBuff[] CurrentDeBuffs => deBuffList.Get();
            ...
            float recoilForce = 40, float attackSpeed = 1)
        {
            ...
            // this.alive = alive;
            if (!alive)
                mindState.SetValue(EnumMindState.Dead);
        }
        ...
        public bool CanNotMoving() => mindState.CanNotMoving() || DuringDeBuff;

        public bool DuringDeBuff => deBuffList.DuringDeBuff;
        ...
        public void Init()
        {
             ...
             * {1} = @default
             */
            _attackableItem = new BoolItem(attackableCoeff);
            _movableItem = new BoolItem(movableCoeff);
